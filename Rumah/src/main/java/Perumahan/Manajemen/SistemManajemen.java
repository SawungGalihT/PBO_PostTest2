...
public class SistemManajemen implements ManajemenRumah {
    ...
    Iterator<Rumah> iterator = daftarRumah.iterator();
    while (iterator.hasNext()) {
        Rumah rumah = iterator.next();
        if (rumah.getNoRumah() == noRumah) {
            iterator.remove(); // Menghapus rumah menggunakan iterator
            System.out.println("Rumah No " + noRumah + " berhasil dihapus.");
            ditemukan = true;
            break;
        }
    }
